    ...
    return (
        <div className="min-h-screen glass min-w-full">
            <div id="nav" className="flex flex-row justify-between top-0 mt-0 px-12">
                <img src={MetaMask} alt="" className="w-32 invert-180"  />
                <ul className="flex flex-row items-center justify-center transition-all ease-in-out duration-300 text-2xl font-Barlow font-light ">
                    <li className="mx-6 my-2 text-[#606060] " >Home</li>
                    <li className="mx-6 my-2 text-[#606060] " >About</li>
                    <li className="mx-6 my-2 text-[#606060] " ><button className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 py-2 px-3 rounded-xl hover:scale-94 text-white" onClick={connectWallet}>Connect</button></li>
                </ul>
            </div>
            ...
            <main className=" bg-gradient-to-b pl-12 flex flex-col justify-center overflow-hidden rounded-lg mt-24">
                ...
                <h2 className="text-5xl font-Dosis my-10 font-extrabold tracking-widest ">Listen | Own | Earn</h2>
                <div className="flex justify-between max-w-sm">
                <button className="px-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 max-w-xs font-semibold py-4 rounded-2xl hover:scale-94 text-2xl text-white" onClick={connectWallet}>Connect Wallet </button>
                <button className="px-4 border-black border-2 max-w-xs font-semibold py-4 rounded-2xl hover:scale-94 text-2xl text-black hover:bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:text-white hover:border-white" onClick={connectWallet}>Learn More </button>
                </div>
            </main>
